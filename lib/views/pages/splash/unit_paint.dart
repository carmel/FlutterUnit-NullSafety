...
class UnitPainter extends CustomPainter {
  ...
  UnitPainter({this.width = 200.0, this.color = Colors.blue,required Animation repaint}):super(repaint: repaint) {
    _paint = Paint();
    _curveAnim= CurvedAnimation(parent: repaint as Animation<double>, curve: Curves.fastOutSlowIn);
  }
